...
const $$SmallBeadcrumb = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="smallBreadcrumb py-8"> <div class="container"> <ul class="d-flex items-center"> <li class="fw-500"> ${renderComponent($$result, "Link", $$Link, { "href": "/", "aria": "", "Class": "d-flex items-center ", "icon": { name: "Home", side: "left" }, "text": defaultPage })} </li> <li class="fw-500 px-5  fs-16 separator">&gt</li> <li class="fw-500"> ${linkPage}</li> </ul> </div> </section>`;
